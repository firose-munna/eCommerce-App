...
class _ProfileScreenState extends State<ProfileScreen> {
  final ReadOrUpdateProfileController readOrUpdateProfileController = Get.find<ReadOrUpdateProfileController>();
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  late TextEditingController customerNameController;
  late TextEditingController customerAddressController = TextEditingController();
  late TextEditingController customerCityController;
  late TextEditingController customerStateController;
  late TextEditingController customerPostCodeController = TextEditingController();
  late TextEditingController customerCountryController = TextEditingController();
  ...
  void initState() {
    ...
    customerNameController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusName ?? '');
    customerAddressController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusAdd ?? '');
    customerCityController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusCity ?? '');
    customerStateController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusState ?? '');
    customerPostCodeController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusPostcode ?? '');
    customerCountryController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusCountry ?? '');
    customerPhoneController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusPhone ?? '');
    customerFaxController = TextEditingController(text: readOrUpdateProfileController.user?.data?.cusFax ?? '');
    shipNameController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipName ?? '');
    shipAddressController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipAdd ?? '');
    shipCityController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipCity ?? '');
    shipStateController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipState ?? '');
    shipPostCodeController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipPostcode ?? '');
    shipCountryController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipCountry ?? '');
    shipPhoneController = TextEditingController(text: readOrUpdateProfileController.user?.data?.shipPhone ?? '');
  }
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            textInputAction: TextInputAction.next,
                            validator: (String? shippingName) {
                              if (shippingName?.isEmpty ?? true) {
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            textInputAction: TextInputAction.next,
                            validator: (String? shippingState) {
                              if (shippingState?.isEmpty ?? true) {
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              prefixIcon: const Icon(Icons.map_sharp),
                              prefixIconColor: theme.primaryColor,
                              hintText: 'Shipping city name',
                            ),
                            keyboardType: TextInputType.text,
                            textInputAction: TextInputAction.next,
                            validator: (String? shippingCity) {
                              if (shippingCity?.isEmpty ?? true) {
                                return 'Shipping city name';
                              }
                              return null;
                            },
                          ),
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            textInputAction: TextInputAction.next,
                            validator: (String? shippingPostCode) {
                              if (shippingPostCode?.isEmpty ?? true) {
                                return 'Shipping post code';
                              }
                              return null;
                            },
                          ),
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            textInputAction: TextInputAction.next,
                            validator: (String? shippingCountry) {
                              if (shippingCountry?.isEmpty ?? true) {
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.phone,
                            textInputAction: TextInputAction.next,
                            validator: (String? shippingPhone) {
                              if (shippingPhone?.isEmpty ?? true) {
                                return 'Enter shipping phone no.';
                              }
                              return null;
                            },
                          ),
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.multiline,
                            textInputAction: TextInputAction.newline,
                            validator: (String? shippingAddress) {
                              if (shippingAddress?.isEmpty ?? true) {
