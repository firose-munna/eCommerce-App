class Urls {
  ...
  static String deleteCart(int productId) => '$_baseUrl/DeleteCartList/$productId';
  static const String readProfile = '$_baseUrl/ReadProfile';
  static const String createProfile = '$_baseUrl/CreateProfile';
  static String productReviewById(int productId) => '$_baseUrl/ListReviewByProduct/$productId';
  ...
  static String addWishList(int productId) => '$_baseUrl/CreateWishList/$productId';
